    ...
    <div style="margin-top: 200px; padding: 20px 150px; ">
        <div style="display: flex; justify-content: center;">
            <div style="width: 500px; margin-top: 50px;">
                ...
                font-size: 40px;">SĐT: 090909123</br>ĐỊA CHỈ: C.E602</br>Mail: Nhom19@gmail.com</p>
            </div>
            <!--
            <div>
        ...
        <div style="display: flex; justify-content: center; margin-top: 80px;">
            <div>
                <img src="./img/About2.jpg" style="width: 200px; height: 200px;">
            </div>
            <div style="width: 500px; margin-top: 50px; margin-left: 30px;">
                <p style="color: white; font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; 
                font-size: 20px;">Chúng tôi luôn luôn hoạt động với phương châm "Khách hàng là thượng đế", luôn cung cấp những gì khách hàng
                cần, luôn giải quyết mọi vấn đề của khách</p>
            </div>
