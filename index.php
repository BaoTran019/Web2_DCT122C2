...
<body>
    ...
    <div class="display-product" >
        <div class="banner"><b><i>NEW ARRIVAL</i></b></div>
        <section class="product-list" style="display: flex; justify-content: center;">
          ...
          <div class="product-illu">
              <a href="./Product_Detail/HeliosNeo16.php">
    ...
    <div class="display-product" >
        <div class="banner"><b><i>BESTSELLER</i></b></div>
        <section class="product-list" style="display: flex; justify-content: center;">
            <div class="product-illu">
                <a href="#">
                  <img src="https://via.placeholder.com/150x150" alt="Sản phẩm 1">
                  <h2>Sản phẩm 1</h2>
                  <p>Giá: 1.000.000đ</p>
                </a>
            </div>  
            <div class="product-illu">
                <a href="#">
                  <img src="https://via.placeholder.com/150x150" alt="Sản phẩm 2">
                  <h2>Sản phẩm 2</h2>
                  <p>Giá: 2.000.000đ</p>
                </a>
            </div>   
            <div class="product-illu">
                <a href="#">
                  <img src="https://via.placeholder.com/150x150" alt="Sản phẩm 3">
                  <h2>Sản phẩm 3</h2>
                  <p>Giá: 3.000.000đ</p>
                </a>
            </div>  
